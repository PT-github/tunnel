    ...
    <div class="tunnel-channel">
      <div class="tunnel-channel-item" v-if="tunnelId">
        ...
        <div class="tunnel-channel-item-right">
          ...
          <div v-else class="tunnel-channel-item-right-num">
            {{countData.unblockedIndexLeft || countData.unblockedIndexRight || 0}}
          </div>
      ...
      <div class="tunnel-channel-item" v-if="tunnelId">
        ...
        <div class="tunnel-channel-item-right">
          ...
          <div v-else class="tunnel-channel-item-right-num">
            {{countData.trafficVolumeLeft || countData.trafficVolumeRight || 0}}
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      passCount: 0,
      countData: {},
      tunnelEventTimer: null
    };
  },

  beforeDestroy() {
    clearInterval(this.tunnelEventTimer)
    this.tunnelEventTimer = null
  },
