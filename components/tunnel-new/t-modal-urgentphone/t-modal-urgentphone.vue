  ...
  <div class="t-modal-urgentphone">
    ...
    <div class="signallamp-content">
      <div class="search-container">
        ...
        <span class="status" :class="{active: form.workMode === 0}" @click="switchWorkMode(0)">空闲</span>
        <span class="status" :class="{active: form.workMode === 1}" @click="switchWorkMode(1)">呼叫中</span>
      ...
      <!-- <div class="info-msg">
        <span>双击对应的紧急电话可进行呼叫</span>
      </div> -->
    </div>

    <div class="operation">
      <span class="cancel" @click="handleCancel">取消</span>
      <!-- <span class="start">执行</span> -->
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      handleSubmit () {
        ...
        this.$service.tunnel_2d.trafficLightsImplement({
