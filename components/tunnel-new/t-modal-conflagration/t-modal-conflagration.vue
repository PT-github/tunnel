<!-- 火灾 -->
<template>
  <view class="t-modal-conflagration">
    <view class="header">
      <text>手动模式-火灾报警</text>
    </view>
    ...
    <view class="signallamp-content">
      <view class="search-container">
        ...
        <text class="status" :class="{active: form.workMode === 1}" @click="switchWorkMode(1)">报警中</text>
      ...
      <scroll-view :show-scrollbar="true" class="scroll-container" scroll-y="true">
        <view class="scroll-content">
          ...
          <!-- <view class="device-item">
            <view class="device-title active">
              <text>报警</text>
            </view>
            <view class="device-info">
              <text>设备名称+桩号</text>
    ...
    data() {
      return {
        ...
        form: {
          ...
          tunnelId: null, // 隧道ID
          classifyNumber: 'conflagration' // 分类
        },
        deviceList: [],
        checkedList: [], // 已选设备列表
        workMode: [], // 控制模式
        workModeChecked: null, // 已选控制模式
        deviceTypeCode: 'conflagration'
      };
    },
    computed: {
      // 隧道单双洞
