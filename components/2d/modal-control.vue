<template>
    <div>
        ...
        <popup-media v-model="showMediaPopup" :medias="showMedias"></popup-media>
    </div>
</template>
...
<script>
    ...
    export default {
        components: {ModalBroadcast, ModalInfoBoard, PopupMedia},
        services: [ '_2d' ],
        props: {
            value: Boolean,
