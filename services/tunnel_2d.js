 ...
 * @LastEditors: PT
 * @LastEditTime: 2021-10-07 15:53:57
...
export default class TwoDService extends Service {
  ...
  // 获取事件统计
  getHomeStatEventCount(data) {
    return this.get({
      url: '/tunnel/rest/pohome/getHomeStatEventCount',
      data,
      method: 'GET',
      retAll: true
    })
  ...
  // 获取事件记录
  getEventPageAll(data) {
    return this.get({
      url: '/tunnel/rest/pohome/getEventPageAll',
      data,
      method: 'GET',
      retAll: true
    })
  ...
  getWarnPageAll(data) {
    return this.get({
      url: '/tunnel/rest/pohome/getWarnPageAll',
      data,
      method: 'GET',
      retAll: true
    })
