<template>
    <form-page no-back>
                ...
                <h-table ref="table"
                    ...
                    <template slot="row" slot-scope="scope">
                        <div style="padding-left: 5px">
                            ...
                            <div class="time-bar">
                                <div class="sort"></div>
                                <div class="times">{{scope.row.date}}</div></div>
                ...
                <tr v-for="(alarm,i) in alarmClassParam" :key="i">
                    ...
                    <th>
                       <el-switch active-value="1"
                                  ...
                                  active-color="#5391F3"></el-switch>
                    <th>
                    <el-switch active-value="1"
                                   inactive-value="0"
                                   @change="switchChange(alarm,i)"
                                   v-model="alarm.isAutoRemind"
                                   active-color="#5391F3"></el-switch></th>
                    <th>{{alarm.reamrks}}</th>
                </tr>
            </table>
        </h-popup>
        ...
        <HPopup :width="$getPx(1272)"
                @handleClose="cannelPopup"
                title="事件处理"
                :showPopup="showDetail">
            <EventAlarm :detail="itemDetail"
                        @uploadList="uploadList"
                        @cannelPopup="cannelPopup"></EventAlarm>
        </HPopup>
    </form-page>
</template>
...
<style scoped lang="less">
    .alarm-btn{
        ...
        font-weight:400;
        color: #C1D9FF;
        img{height: 12px;width: 12px;margin-right: 4px}
    }
    .time-line-ctn{
        /deep/ .table{
            background: none;
