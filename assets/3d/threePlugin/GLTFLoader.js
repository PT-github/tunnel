...
// import UtilDB from '../tools/indexDB';
...
var GLTFLoader = (function () {
	...
	GLTFLoader.prototype = {
		...
		load: function (url, onLoad, onProgress, onError) {
			...
			let find = false;
			this.db.openDB('bim', 1, 'fileName').then(res => {
				scope.db.getAllData(d => {
					for (let i = 0; i < d.length; i++) {
						...
						if (element.fileName == fileName) {
							...
							console.log('find from local!');
							try {
								scope.parse(element.file, resourcePath, function (gltf) {
	...
	GLTFParser.prototype.loadAccessor = function (accessorIndex) {
		...
		if (accessorDef.bufferView !== undefined) {
			var data = this.getDependency('bufferView', accessorDef.bufferView);
			pendingBufferViews.push(data);
